...
if __name__ == '__main__':
    ...
    # Fusion Network
    solver = Solver('fusion', args, train_loader=train_loader, dev_loader=valid_loader,
                    test_loader=test_loader, is_train=True)
    solver.train_and_eval()

    # # Unimodal - Text
    # solver_text = Solver('text', args, train_loader=train_loader, dev_loader=valid_loader,
    #                 test_loader=test_loader, is_train=True)
    # solver_text.train_and_eval()

    # # Unimodal - Acoustic
    # solver_acoustic = Solver('acoustic', args, train_loader=train_loader, dev_loader=valid_loader,
    #                 test_loader=test_loader, is_train=True)
    # solver_acoustic.train_and_eval()

    # # Unimodal - Visual
    # solver_visual = Solver('visual', args, train_loader=train_loader, dev_loader=valid_loader,
    #                 test_loader=test_loader, is_train=True)
    # solver_visual.train_and_eval()